...
### [3] [DietDelta: A Vision-Language Approach for Dietary Assessment via Before-and-After Images](https://arxiv.org/abs/2604.06352)
...
### [6] [URMF: Uncertainty-aware Robust Multimodal Fusion for Multimodal Sarcasm Detection](https://arxiv.org/abs/2604.06728)
...
### [8] [SurFITR: A Dataset for Surveillance Image Forgery Detection and Localisation](https://arxiv.org/abs/2604.07101)
...
### [10] [Appear2Meaning: A Cross-Cultural Benchmark for Structured Cultural Metadata Inference from Images](https://arxiv.org/abs/2604.07338)
...
### [38] [DINO-QPM: Adapting Visual Foundation Models for Globally Interpretable Image Classification](https://arxiv.org/abs/2604.07166)
...
### [74] [Assessing the Added Value of Onboard Earth Observation Processing with the IRIDE HEO Service Segment](https://arxiv.org/abs/2604.07120)
...
### [75] [Accuracy Improvement of Semi-Supervised Segmentation Using Supervised ClassMix and Sup-Unsup Feature Discriminator](https://arxiv.org/abs/2604.07122)
...
### [76] [A Utility-preserving De-identification Pipeline for Cross-hospital Radiology Data Sharing](https://arxiv.org/abs/2604.07128)
...
### [77] [CSA-Graphs: A Privacy-Preserving Structural Dataset for Child Sexual Abuse Research](https://arxiv.org/abs/2604.07132)
...
### [78] [USCNet: Transformer-Based Multimodal Fusion with Segmentation Guidance for Urolithiasis Classification](https://arxiv.org/abs/2604.07141)
...
### [79] [Learning to Search: A Decision-Based Agent for Knowledge-Based Visual Question Answering](https://arxiv.org/abs/2604.07146)
...
### [81] [Energy-based Tissue Manifolds for Longitudinal Multiparametric MRI Analysis](https://arxiv.org/abs/2604.07180)
...
### [82] [TeaLeafVision: An Explainable and Robust Deep Learning Framework for Tea Leaf Disease Classification](https://arxiv.org/abs/2604.07182)
...
### [91] [Region-Graph Optimal Transport Routing for Mixture-of-Experts Whole-Slide Image Classification](https://arxiv.org/abs/2604.07298)
...
### [92] [Beyond Loss Values: Robust Dynamic Pruning via Loss Trajectory Alignment](https://arxiv.org/abs/2604.07306)
...
### [93] [Distilling Photon-Counting CT into Routine Chest CT through Clinically Validated Degradation Modeling](https://arxiv.org/abs/2604.07329)
...
### [94] [From Blobs to Spokes: High-Fidelity Surface Reconstruction via Oriented Gaussians](https://arxiv.org/abs/2604.07337)
...
### [227] [X-BCD: Explainable Sensor-Based Behavioral Change Detection in Smart Home Environments](https://arxiv.org/abs/2604.06174)
...
### [228] [User-Centric Design of UI for Mobile Banking Apps: Improving UI and Features for Better Customer Experience](https://arxiv.org/abs/2604.06175)
...
### [229] ["Help Me, But Don't Watch Me": Intervention Timing and Privacy Boundaries for Process-Aware AI Tutors](https://arxiv.org/abs/2604.06178)
...
### [230] [Language-Guided Multimodal Texture Authoring via Generative Models](https://arxiv.org/abs/2604.06489)
...
### [231] [Digital Weight Management Interventions: A review of commercial solutions and survey analysis of user needs](https://arxiv.org/abs/2604.06181)
...
### [232] [VenusBench-Mobile: A Challenging and User-Centric Benchmark for Mobile GUI Agents with Capability Diagnostics](https://arxiv.org/abs/2604.06182)
...
### [233] [The Impact of Response Latency and Task Type on Human-LLM Interaction and Perception](https://arxiv.org/abs/2604.06183)
...
### [234] [BATON: A Multimodal Benchmark for Bidirectional Automation Transition Observation in Naturalistic Driving](https://arxiv.org/abs/2604.07263)
...
### [235] [A Goal-Oriented Chatbot for Engaging the Elderly Through Family Photo Conversations](https://arxiv.org/abs/2604.06184)
...
### [236] [Benchmarking LLM Tool-Use in the Wild](https://arxiv.org/abs/2604.06185)
...
### [237] [Full State-Space Visualisation of the 8-Puzzle: Feasibility, Design, and Educational Use](https://arxiv.org/abs/2604.06186)
...
### [238] [Skin-Deep Bias: How Avatar Appearances Shape Perceptions of AI Hiring](https://arxiv.org/abs/2604.06187)
...
### [239] [LLM Spirals of Delusion: A Benchmarking Audit Study of AI Chatbot Interfaces](https://arxiv.org/abs/2604.06188)
...
### [240] [SASLO: A Scene-Aware Spatial Layout Optimization System for AR-SSVEP](https://arxiv.org/abs/2604.06190)
...
### [241] ["It didn't feel right but I needed a job so desperately": Understanding People's Emotions & Help Needs During Financial Scams](https://arxiv.org/abs/2604.06218)
...
### [242] [Navigating Marginalization: Toward Justice-Oriented Socio-Technical Design for Parent-Child Learning among Southeast Asian Immigrant Mothers in Taiwan](https://arxiv.org/abs/2604.06353)
...
### [243] [Intimacy as Service, Harm as Externality: Critical Perspectives on AI Companion Platform Accountability](https://arxiv.org/abs/2604.06381)
...
### [244] [Reproducibility Beyond Artifacts: Interactional Support for Collaborative Machine Learning](https://arxiv.org/abs/2604.06414)
...
### [245] [Trust in AI among Middle Eastern CS Students: Investigating Students' Trust and Usage Patterns Across Saudi Arabia, Kuwait and Jordan](https://arxiv.org/abs/2604.06418)
...
### [246] [Intimate Strangers by Design: A Uses and Gratifications Analysis of AI Companionship](https://arxiv.org/abs/2604.06419)
*Dayeon Eom,Julianne Renner,Sedona Chinn*
...
### [247] [Breaking Negative Cycles: A Reflection-To-Action System For Adaptive Change](https://arxiv.org/abs/2604.06477)
...
### [248] [Meaningful Human Command: Towards a New Model for Military Human-Robot Interaction](https://arxiv.org/abs/2604.06611)
...
### [249] [MemoryDiorama: Generating Dynamic 3D Diorama from Everyday Photos for Memory Recall](https://arxiv.org/abs/2604.06773)
...
### [250] [Physics-driven Sonification for Improving Multisensory Needle Guidance in Percutaneous Epicardial Access](https://arxiv.org/abs/2604.06911)
...
### [251] [BioMoTouch: Touch-Based Behavioral Authentication via Biometric-Motion Interaction Modeling](https://arxiv.org/abs/2604.07071)
...
### [252] [Workmanship of Learning: Embedding Craftsmanship Values in AI-Integrated Educational Tools](https://arxiv.org/abs/2604.07118)
...
### [253] [Mixed-Initiative Context: Structuring and Managing Context for Human-AI Collaboration](https://arxiv.org/abs/2604.07121)
...
### [254] [Critical Inker: Scaffolding Critical Thinking in AI-Assisted Writing Through Socratic Questioning](https://arxiv.org/abs/2604.07167)
...
### [255] [Reshaping Inclusive Interpersonal Dynamics through Smart Glasses in Mixed-Vision Social Activities](https://arxiv.org/abs/2604.07232)
...
### [256] [Mapping Child Malnutrition and Measuring Efficiency of Community Healthcare Workers through Location Based Games in India](https://arxiv.org/abs/2604.07299)
...
### [257] [NIRVANA: A Comprehensive Dataset for Reproducing How Students Use Generative AI for Essay Writing](https://arxiv.org/abs/2604.07344)
...
### [281] [LungCURE: Benchmarking Multimodal Real-World Clinical Reasoning for Precision Lung Cancer Diagnosis and Treatment](https://arxiv.org/abs/2604.06925)
