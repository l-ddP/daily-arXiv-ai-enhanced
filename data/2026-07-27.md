...
### [83] [Control panels to clarify user intent with Large Language Models](https://arxiv.org/abs/2607.21598)
*Ben Shneiderman*
...
### [84] [Analyzing Middle School Students' Dialogue and Behaviors during Collaborative AI Chatbot Development Using Ordered Network Analysis](https://arxiv.org/abs/2607.21603)
...
### [85] [Natural Language Processing in Health Professions Education: A Scoping Review](https://arxiv.org/abs/2607.21605)
...
### [86] [A Systematic Survey on Image Description Techniques for STEM Domains](https://arxiv.org/abs/2607.21611)
...
### [87] [Charting the Moral Universe: Capturing Virtues and Values of Data Visualization Practice](https://arxiv.org/abs/2607.21732)
...
### [88] [Bespoke Visual Assistance: What and How do Blind and Low-Vision People Create with Agentic Programming?](https://arxiv.org/abs/2607.21760)
...
### [89] [Unboxing Diffusion Models for the Arts: Interactive Model Bending and Practice-Based Explainability](https://arxiv.org/abs/2607.22428)
...
### [90] [From Grasping to Speaking: Generative AI-Based Environment-Grounded VR Communication Training for Autistic Individuals](https://arxiv.org/abs/2607.21769)
...
### [91] [AI-Integrated Scientific Inquiry: A Practice-Centered Vision for Science Education](https://arxiv.org/abs/2607.21777)
...
### [92] [Adaptive Driving Style for SAE Level-2 Driving Automation: Minimizing Preference Mismatch](https://arxiv.org/abs/2607.21819)
...
### [93] [Filtering Offensive Content Changes Its Visibility but Not User Behavior: Two Randomized Controlled Trials with 200,000 Users on Nextdoor](https://arxiv.org/abs/2607.21853)
...
### [94] [VisCanvas: A Node-based Interface for Exploratory Visualization Authoring with LLMs](https://arxiv.org/abs/2607.21886)
...
### [95] [Towards Reducing Foreign Language Anxiety Using Level-Appropriate Embodied Conversational Agents](https://arxiv.org/abs/2607.21887)
...
### [96] [VisionPulse: A Virtual Reality System Enabling Accessible Discovery and Navigation for Blind and Low Vision Users](https://arxiv.org/abs/2607.21944)
...
### [97] [What Clinicians Need: Designing, Developing and Evaluating an AI-Based Decision Support System for Autism Assessment](https://arxiv.org/abs/2607.22005)
...
### [98] [The machine can say it but cannot hear it. Designed affective patterns and the expressive-sensing asymmetry in human-machine communication](https://arxiv.org/abs/2607.22104)
*Jan K. Argasinski*
...
### [99] [An AI-Driven Virtual Patient for Breaking Bad News: An Expert Formative Study on Facial Expression Intensity](https://arxiv.org/abs/2607.22118)
...
### [100] [Kutti AI: A Voice-First, Offline-Capable Learning Companion with Real-Time Struggle Detection for Visually-Impaired Children](https://arxiv.org/abs/2607.22377)
...
### [101] [Universal BCI Personalization: One API for Frozen EEG Trunks and Foundation Models](https://arxiv.org/abs/2607.22397)
*Sergey Musienko*
...
### [102] [Beyond Perspectives: A Trio-Ethnography of Interpretation Evolution in LLM-Supported Programming Education](https://arxiv.org/abs/2607.22463)
...
### [103] [Gridnberg: A Topography-Aware Pedestrian Routing Dataset for New York City](https://arxiv.org/abs/2607.22523)
*Ariel Noyman*
...
### [104] [Unsupervised Multimodal Intent Discovery via MLLM-Guided Concept Generation and Semantic Propagation](https://arxiv.org/abs/2607.21908)
...
### [105] [CARA: Concept-Aware Risk Attention for Interpretable Collision Anticipation](https://arxiv.org/abs/2607.22494)
...
### [132] [FlowEvo: Self-Evolving Agents through the Co-Evolution of Workflows and Executable Skills](https://arxiv.org/abs/2607.21596)
...
### [133] [Risk Is Not the Target: A Monotonic Framework for Evaluating Wildfire Operational Risk Signals](https://arxiv.org/abs/2607.21597)
...
### [134] [Securing Multimodal AI through Internal Information Decomposition](https://arxiv.org/abs/2607.21600)
...
### [135] [From Frame-Level Recognition to Event-Level Confirmation: Repair Traces and Runtime Failure Analysis of Public-Space Gesture Interaction](https://arxiv.org/abs/2607.21601)
...
### [136] [Transferable Latency Prediction for Fast LLM Screening on Heterogeneous Edge Devices](https://arxiv.org/abs/2607.21602)
...
### [137] [AgentKVShift: Efficient KV Cache Reuse for Agentic Memory Systems](https://arxiv.org/abs/2607.21604)
...
### [138] [TILT: Improving Compositional Generation in Diffusion Models with a Model-Intrinsic Reward](https://arxiv.org/abs/2607.21606)
...
### [139] [Spectral Flow Certificates for Depth-Aware Long-Range Propagation in Graph Neural Networks](https://arxiv.org/abs/2607.21607)
...
### [140] [Coupled Hierarchical Search over Topology and Execution for Agentic Workflow Synthesis](https://arxiv.org/abs/2607.21609)
...
### [141] [SCOPE and SCION: A Benchmark and an Auditable Reference Pipeline for Schema Induction and Fusion from Text](https://arxiv.org/abs/2607.21610)
...
### [142] [Procedural Knowledge Is Not Low-Rank: Why LoRA Fails to Internalize Multi-Step Procedures](https://arxiv.org/abs/2607.21612)
...
### [143] [The Hard Decision Layer: Evidence for Committed Inference in Transformers](https://arxiv.org/abs/2607.21613)
...
### [144] [Household Movement Detection in Mixed-Format Occupancy Data Using LLM-Based Entity Resolution](https://arxiv.org/abs/2607.21614)
...
### [145] [FrED: External Data Influence Estimation via Domain Knowledge Graph Grounding](https://arxiv.org/abs/2607.21615)
...
### [146] [Lost in Context: Addressing Context Anxiety in Large Language Models](https://arxiv.org/abs/2607.21616)
...
### [147] [Do VLMs Read or Rewrite? On Transcription Faithfulness in Vision-Language Models](https://arxiv.org/abs/2607.21617)
...
### [148] [LeafData: An Agentic System for Data Migration](https://arxiv.org/abs/2607.21618)
...
### [149] [From Profiles to Steering Vectors: Global Sparse Priors and Local Semantic Calibration for Personalized Text Generation](https://arxiv.org/abs/2607.21620)
...
### [150] [FBLayout: Optimizing Memory Layout for Efficient LLM Finetuning on Mobile GPUs](https://arxiv.org/abs/2607.21624)
...
### [157] [What AI Red-Team Evaluations Can and Cannot Prove](https://arxiv.org/abs/2607.21735)
*Bandana Kaur*
...
### [162] [Zero-Shot Mission-Level Evaluation for Aerial MLLM Agents](https://arxiv.org/abs/2607.22014)
...
### [163] [Multi-Agent System-driven Digital Twins for predictive maintenance: architectures, technologies and open research challenges](https://arxiv.org/abs/2607.21873)
...
### [164] [TRW: TRACE-RealWorld---An Auditable Consistency Contract for World Models as Materialized Views](https://arxiv.org/abs/2607.21910)
*Edward Y. Chang*
...
### [165] [Semiotic logical hexagon theory for LLM logical reasoning](https://arxiv.org/abs/2607.21933)
...
### [166] [Learning as Reasoning Unfolds: Progressive Rollout Allocation for Efficient Reinforcement Learning](https://arxiv.org/abs/2607.22002)
...
### [179] [Dynamic Capability Scoping for Enterprise AI Agents: A Synthetic Dataset and Three-Source Permission Architecture](https://arxiv.org/abs/2607.22445)
*Halil Burak Noyan*
...
### [181] [The Regression Tax: Decomposing Why Skills Help and Hurt LLM Agents](https://arxiv.org/abs/2607.22520)
...
### [182] [Explainable Reinforcement Learning for assisting Air Traffic Controllers](https://arxiv.org/abs/2607.22525)
